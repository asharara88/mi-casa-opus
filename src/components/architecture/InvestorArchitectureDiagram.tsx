...
const InvestorArchitectureDiagram = () => {
  return (
    <div className="max-w-5xl mx-auto px-4 md:px-6 print:px-4">
      {/* Header */}
      <div className="text-center mb-6 md:mb-10 print:mb-8">
        <h1 className="text-2xl md:text-4xl font-bold text-gray-900 dark:text-white mb-2 print:text-3xl">
          MiCasa Platform Architecture
        </h1>
        <p className="text-sm md:text-lg text-gray-600 dark:text-gray-400 mb-1">
          Abu Dhabi Sales Brokerage
        </p>
        <p className="text-xs md:text-sm text-gray-500 dark:text-gray-500 max-w-3xl mx-auto">
          Inventory-agnostic, conversation-first operating system for compliant Abu Dhabi real estate sales operations
        </p>
      </div>

      {/* Key Metrics Bar */}
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4 mb-6 md:mb-10 print:mb-8">
        {[
          ...
          <div key={idx} className="bg-gray-50 dark:bg-gray-900 rounded-xl p-3 md:p-4 text-center border border-gray-200 dark:border-gray-800">
            <metric.icon className="w-4 h-4 md:w-5 md:h-5 mx-auto mb-1 md:mb-2 text-emerald-600 dark:text-emerald-400" />
            <div className="text-lg md:text-2xl font-bold text-gray-900 dark:text-white">{metric.value}</div>
            <div className="text-[10px] md:text-xs text-gray-500 dark:text-gray-400 mt-1">{metric.label}</div>
          </div>
        ))}
      </div>
        ...
        <div className="relative">
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-2xl p-5 text-white shadow-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-3">
              ...
              <div className="md:col-span-5 bg-white/15 rounded-lg p-3 border border-white/20">
                <div className="flex items-center gap-2 mb-1 flex-wrap">
                  <Building2 className="w-4 h-4" />
                  <span className="font-semibold text-sm md:text-base">Property Finder</span>
                  <Badge className="bg-white text-blue-700 text-[10px] px-1.5 py-0 font-semibold">PRIMARY</Badge>
                </div>
                <p className="text-[10px] md:text-[11px] text-blue-100">Enterprise API + webhooks • Structured lead metadata</p>
              </div>
              
              {/* Bayut - Secondary */}
              <div className="md:col-span-3 bg-white/10 rounded-lg p-3">
                <div className="flex items-center gap-2 mb-1">
                  <Building2 className="w-4 h-4 text-blue-200" />
                  <span className="font-medium text-blue-100 text-sm">Bayut</span>
                </div>
                <p className="text-[10px] text-blue-200">Secondary source (where integration exists)</p>
              </div>
              
              {/* Other Sources */}
              <div className="md:col-span-4 bg-white/10 rounded-lg p-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="bg-white/10 rounded-lg p-3 md:p-4">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="font-semibold text-sm">Workflow Engine (non-AI rules)</span>
                </div>
                <div className="grid grid-cols-2 gap-2 mb-3">
                  {['Consent Check', 'Time Windows', 'DNCR', 'Templates'].map((rule, i) => (
                    <div key={i} className="bg-white/10 rounded px-2 py-1.5 text-xs flex items-center gap-1.5">
                      ...
                      {rule}
                      {rule === 'Templates' && <span className="text-[9px] text-purple-200 hidden sm:inline">(speed shortcuts)</span>}
                    </div>
                  ))}
                </div>
              ...
              <div className="bg-white/10 rounded-lg p-3 md:p-4">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <span className="font-semibold text-sm">AI Interpretation (drafts only)</span>
                </div>
      ...
      <div className="mt-6 md:mt-8 grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4 print:mt-6">
        {/* Regulatory-First */}
        <div className="bg-gradient-to-br from-red-50 to-red-100 dark:from-red-950/40 dark:to-red-900/30 rounded-xl p-3 md:p-4 border border-red-200 dark:border-red-800/50">
          <div className="flex items-center gap-2 mb-2 md:mb-3">
            <Shield className="w-4 h-4 md:w-5 md:h-5 text-red-600 dark:text-red-400" />
            <h3 className="font-bold text-red-900 dark:text-red-300 text-sm md:text-base">Regulatory-First</h3>
          </div>
          <p className="text-[10px] md:text-xs text-gray-700 dark:text-gray-300 leading-relaxed">
        ...
        {/* AI-Bounded */}
        <div className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-950/40 dark:to-purple-900/30 rounded-xl p-3 md:p-4 border border-purple-200 dark:border-purple-800/50">
          <div className="flex items-center gap-2 mb-2 md:mb-3">
            <Lock className="w-4 h-4 md:w-5 md:h-5 text-purple-600 dark:text-purple-400" />
            <h3 className="font-bold text-purple-900 dark:text-purple-300 text-sm md:text-base">AI-Bounded</h3>
          </div>
          <p className="text-[10px] md:text-xs text-gray-700 dark:text-gray-300 leading-relaxed">
        ...
        {/* Audit-Ready */}
        <div className="bg-gradient-to-br from-emerald-50 to-emerald-100 dark:from-emerald-950/40 dark:to-emerald-900/30 rounded-xl p-3 md:p-4 border border-emerald-200 dark:border-emerald-800/50">
          <div className="flex items-center gap-2 mb-2 md:mb-3">
            <BookOpen className="w-4 h-4 md:w-5 md:h-5 text-emerald-600 dark:text-emerald-400" />
            <h3 className="font-bold text-emerald-900 dark:text-emerald-300 text-sm md:text-base">Audit-Ready</h3>
          </div>
          <p className="text-[10px] md:text-xs text-gray-700 dark:text-gray-300 leading-relaxed">
